...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/prism", fork = TRUE)`.
...
Please note that the prism project is released with a [Contributor Code
of Conduct](https://docs.ropensci.org/CONDUCT.md). By contributing to
